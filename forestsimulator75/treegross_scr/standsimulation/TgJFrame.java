...
import treegross.harvesting.*;
import treegross.roots.*;
...
{	
   String bwinproVersion="Version 7.5.15 XML";
   String bwinproLastUpdate="23-12-2010";
   boolean accessInput = false;
...
//
        if (plugIn.indexOf("nwfva") > 0) {
            accessInput = true;
                ...
                SDM.readFromPath(programDir+System.getProperty("file.separator")+st.FileXMLSettings);
                st.setSDM(SDM);
...
//                user.currentDir();
           ...
           // adding the menu
	 	menubar = new MyMenubar(this, this, language,accessInput); 
...
//                       Treatment te= new Treatment();
                ...
                if (cmd.equals("openAccess")){
                   System.out.println("Open Access File"); 
                   try {
                       String modelPlugIn="treegross.DBAccess.DBAccess";  
                       PlugInDBAccess dialog = (PlugInDBAccess)Class.forName(modelPlugIn).newInstance();  
...
//                       gxy.zufall(st);
                   ...
                   catch (Exception ex){System.out.println(ex);System.out.println("kein Access Plugin Vorhanden "); }
...
//                
 ...
 //                
                  if (cmd.equals("Introduction")){ 
                      String fileName=user.programDir+System.getProperty("file.separator")+"help"+System.getProperty("file.separator")+"ForestSimulator.pdf";
...
//                pp.neuzeichnen();
            ...
            {
                    SortingDialog sorter = new SortingDialog(this, true, st, programDir, false, workingDir);
            ...
            {
                    NutrientBalanceDialog nutrientBalance = new NutrientBalanceDialog(this, true, st, programDir, false, workingDir);
