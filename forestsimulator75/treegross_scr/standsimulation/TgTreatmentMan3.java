...
public class TgTreatmentMan3 extends javax.swing.JPanel {
    ...
    public TgTreatmentMan3(Stand stparent,  TgJFrame frameparent, String preferredLanguage) {
        ...
        messages = ResourceBundle.getBundle("treegross.standsimulation.TgTreatmentMan3",currentLocale);
        ...
        jComboBox4.addItem(messages.getString("none"));
        jComboBox4.addItem(messages.getString("low"));
        jComboBox4.addItem(messages.getString("moderate"));
        jComboBox4.addItem(messages.getString("heavy"));
        jComboBox4.addItem(messages.getString("veryheavy"));
...
//    st.ingrowthActive=true;
    ...
    int nSimSteps = (int) Math.ceil(Double.parseDouble(jTextField5.getText())/5.0);
    for (int i=0;i<nSimSteps;i++){
        st.descspecies();
        treat.executeManager2(st);
        st.descspecies();
        int time = 5;
        if (simTime < 5) time= simTime;
...
/** loads the species settings    */
    public void loadTable(){
        ...
        jCheckBox1.setSelected(st.randomGrowthEffects);
        ...
        for (int i=0; i< st.nspecies; i++){
               ...
               Integer nct = st.sp[i].trule.numberCropTreesWanted;
    ...
    public void loadSettingsToStandRule() {
      st.randomGrowthEffects = jCheckBox1.isSelected();
 ...
 //      
      for (int i=0; i < jTable1.getRowCount(); i++){
          ...
          if (merk > -9){
             ...
             st.sp[merk].trule.numberCropTreesWanted = Integer.parseInt((String)(jTable1.getValueAt(i,4)));
          }
       }
      double sum=0.0; 
