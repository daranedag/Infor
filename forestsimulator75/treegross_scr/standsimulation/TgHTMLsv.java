...
{ 
	...
	void newreport(Stand st, String path, String fname, String preferredLanguage )
	{  
           Locale currentLocale;
           currentLocale = new Locale(preferredLanguage, "");
           messages = ResourceBundle.getBundle("treegross.standsimulation.TgHTMLsv",currentLocale);
