...
// File 
        ...
        rootElt= addString(rootElt, "Tamaño_Area_m2",new Double(st.size*10000).toString());
        rootElt= addString(rootElt, "CodigoStdTipoArbolPrincipal",new Integer(st.sp[0].code).toString());
        rootElt= addString(rootElt, "CodigoLocalTipoArbolPrincipal",new Integer(st.sp[0].code).toString());
        ...
        rootElt= addString(rootElt, "ValorAlto_m",new Double(st.hochwert_m).toString());
        ...
        rootElt= addString(rootElt, "AreaDeCrecimiento",st.wuchsgebiet);
        rootElt= addString(rootElt, "DistritoCrecimiento",st.wuchsbezirk);
        rootElt= addString(rootElt, "UbicacionNumeroCodigo",st.standortsKennziffer);
