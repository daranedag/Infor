 ...
 * treatment rules that refer to different treatment for different species
 * can be defined
 */
public class TreatmentRuleSpecies implements Cloneable{
     ...
     * @param p_targetDiameter target percentage of crown surface of living trees (%)
    ...
    public TreatmentRuleSpecies clone(){
       ...
       clone.maxAge= new Double(this.maxAge);
       clone.minCropTreeHeight= new Double(this.minCropTreeHeight);
       clone.numberCropTreesWanted= new Integer(this.numberCropTreesWanted);
       clone.targetAgeLayer= new Double(this.targetAgeLayer);
       clone.targetCrownPercent= new Double(this.targetCrownPercent);
       clone.targetDiameter= new Double(this.targetDiameter);
       clone.targetDiameterLayer= new Double(this.targetDiameterLayer);
       clone.targetRang= new Integer(this.targetRang);
       clone.thinningIntensity= new Double(this.thinningIntensity);
       return clone;
    }
