...
/** This class is the plugin adapter for the calculation of a risk mortality model.
 *  The model needs to be based on the stand and tree classes.
 *   
 *  - Version 7.1 2-AUG-2007  */

public interface PlugInRisk
{ 
