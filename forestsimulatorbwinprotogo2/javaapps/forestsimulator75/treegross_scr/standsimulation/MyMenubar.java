...
{	
    ...
    public MyMenubar(ActionListener listener, ItemListener Ilistener, String preferredLanguage, boolean accessInput)
...
//1.6.1 Bwin62.txt_to XML
		...
		mi.addActionListener(listener);
		m.add(mi);
//1.6.1 treegross.xml_to glm
                if (accessInput) {
		mi = new JMenuItem("treegross.xml -> gml");
		mi.setActionCommand("treegross2gml");
		mi.addActionListener(listener);
		m.add(mi);
                }
